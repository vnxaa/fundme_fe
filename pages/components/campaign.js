            ...
            <div className="hidden sm:block sm:w-1/2 lg:w-3/4 relative">
                ...
                <div className="text-left sm:w-2/3 lg:w-2/5 flex flex-col justify-evenly relative z-20">
                    ...
                    <div className="flex mt-8">
                        <a href={urlExplore} className="py-4 px-4  bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg ">
                            Explore
                        </a>
                    </div>
                </div>
